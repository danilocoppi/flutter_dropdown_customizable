...
typedef CustomDropdownButtonBuilder = List<Widget> Function(BuildContext context);
...
class _DropdownMenuPainter extends CustomPainter {
  _DropdownMenuPainter({
    ...
    this.dropdownMenuRadius,
    this.dropdownMenuBorder,
    this.dropdownMenuGradient,
  })  : _painter = BoxDecoration(
          // If you add an image here, you must provide a real
          // configuration in the paint() function and you must provide some sort
          // of onChanged callback here.
          gradient: dropdownMenuGradient,
          color: color,
          borderRadius: BorderRadius.circular(dropdownMenuRadius),
  ...
  final double dropdownMenuRadius;
  final Border dropdownMenuBorder;
  final Gradient dropdownMenuGradient;
...
class _DropdownMenuItemButtonState<T> extends State<_DropdownMenuItemButton<T>> {
  void _handleFocusChange(bool focused) {
    ...
    if (focused && inTraditionalMode) {
      final _MenuLimits menuLimits = widget.route
          .getMenuLimits(widget.buttonRect, widget.constraints.maxHeight, widget.itemIndex, widget.route.dropdownMenuIgnoreOffset);
    ...
    return FadeTransition(
      ...
      child: CustomPaint(
        painter: _DropdownMenuPainter(
          ...
          getSelectedItemOffset: () => route.getItemOffset(route.selectedIndex, route.dropdownMenuIgnoreOffset),
          dropdownMenuRadius: route.dropdownMenuRadius,
          dropdownMenuBorder: route.dropdownMenuBorder,
          dropdownMenuGradient: route.dropdownMenuGradient,
        ),
        child: Semantics(
          scopesRoute: true,
          namesRoute: true,
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    final _MenuLimits menuLimits = route.getMenuLimits(buttonRect, size.height, route.selectedIndex, route.dropdownMenuIgnoreOffset);
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  _DropdownRoute({
    ...
    this.itemHeight,
    this.dropdownColor,
    this.dropdownMenuRadius = 2,
    this.dropdownMenuBorder,
    this.dropdownMenuGradient,
    this.dropdownMenuIgnoreOffset = false,
  })  : assert(style != null),
  ...
  final Border dropdownMenuBorder;
  final Gradient dropdownMenuGradient;
  final bool dropdownMenuIgnoreOffset;
  ...
  double getItemOffset(int index, bool ignoreOffset) {
    ...
    return ignoreOffset ? kMaterialListPadding.top : offset;
  }
  ...
  _MenuLimits getMenuLimits(Rect buttonRect, double availableHeight, int index, bool ignoreOffset) {
    final double maxMenuHeight = availableHeight - 2.0 * _kMenuItemHeight;
    final double buttonTop = buttonRect.top;
    final double buttonBottom = math.min(buttonRect.bottom, availableHeight);
    final double selectedItemOffset = getItemOffset(index, ignoreOffset);
...
class _DropdownRoutePage<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (route.scrollController == null) {
      final _MenuLimits menuLimits = route.getMenuLimits(buttonRect, constraints.maxHeight, selectedIndex, dropdownMenuIgnoreOffset);
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  /// {@template flutter.material.CustomDropdownButton.onChanged}
  ...
  /// Gradient color to be set on dropdown menu background
  final Gradient dropdownMenuGradient;

  /// The drawing will ignores the selected index to show aligned menu
  final bool dropdownMenuIgnoreOffset;
...
class _CustomDropdownButtonState<T> extends State<CustomDropdownButton<T>> with WidgetsBindingObserver {
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      ...
      dropdownMenuRadius: widget.dropdownMenuRadius,
      dropdownMenuBorder: widget.dropdownMenuBorder,
      dropdownMenuGradient: widget.dropdownMenuGradient,
      dropdownMenuIgnoreOffset: widget.dropdownMenuIgnoreOffset,
    );
  ...
  Widget build(BuildContext context) {
    ...
    if (_enabled) {
      ...
      items = widget.selectedItemBuilder == null ? <Widget>[] : widget.selectedItemBuilder(context);
    }
...
class CustomDropdownButtonFormField<T> extends FormField<T> {
  ...
  CustomDropdownButtonFormField({
    ...
    double dropdownMenuRadius = 2,
    Border dropdownMenuBorder,
    bool dropdownMenuIgnoreOffset,
  })  : assert(
          items == null ||
              items.isEmpty ||
              value == null ||
                ...
                return InputDecorator(
                  ...
                  child: CustomDropdownButtonHideUnderline(
                    child: CustomDropdownButton<T>(
                      ...
                      autofocus: autofocus,
                      dropdownColor: dropdownColor,
                      dropdownMenuRadius: dropdownMenuRadius,
                      dropdownMenuBorder: dropdownMenuBorder,
                      dropdownMenuIgnoreOffset: dropdownMenuIgnoreOffset,
                    ),
                  ),
                );
              }),
  ...
  /// {@macro flutter.material.CustomDropdownButton.onChanged}
  final ValueChanged<T> onChanged;
